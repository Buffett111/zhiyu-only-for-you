...
export const financeModule: ModuleDefinition = { id: 'finance', name: '財經', description: '追蹤台股、美股與日股，每天留意你關心的市場變化。', version: '1.4.0', configVersion: 1, icon: 'chart', routes: ['/finance'], jobs: ['market.sync', 'international.sync', 'news.sync', 'history.backfill', 'digest.generate', 'fundamentals.sync'], widgets: [
