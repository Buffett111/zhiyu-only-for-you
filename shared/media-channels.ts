...
export interface MediaChannel {
 key:string;name:string;url:string|null;estimatedSeconds:number|null;count:number;videos:number;share:number;
...
export interface ChannelOverview {
 ...
 processing:{autoClassify:boolean;status:string;error:string|null;lastSuccess:string|null;dailyBatches:number;dailyLimit:number};
}
